    ...
    def __getitem__(self, index):
        ...
        if self.use_pose:
            ...
            if self.model_type in ['FUSION']:
                # in org: shape (3, 224, 224)  | after modif to stretched_image_from_skeleton_sequence_4() : (c=3, t=20, v=25, m=2):
                skeleton_image = np.float32(stretched_image_from_skeleton_sequence_4(skeleton, self.c_min, self.c_max))
